...
CONFIG += debug 
QT = core gui
SOURCES += source/main.cpp source/WorkTime.cpp source/Status.cpp source/SqlConnector.cpp source/Exception.cpp source/Team.cpp source/Wages.cpp source/User.cpp source/DateTime.cpp source/BaseRecord.cpp source/Report.cpp source/NumberToStringConverter.cpp source/Group.cpp source/Task.cpp source/Project.cpp
HEADERS += header/BaseRecord.h header/ERROR_CODES.h header/Team.h header/WorkTime.h header/SqlConnector.h header/Task.h header/DateTime.h header/Exception.h header/User.h header/Project.h header/Status.h header/Group.h header/NumberToStringConverter.h header/Wages.h header/Report.h
