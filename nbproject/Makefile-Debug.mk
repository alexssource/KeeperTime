...
include KeeperTime-Makefile.mk
...
LDLIBSOPTIONS=-Wl,-rpath /usr/local/lib -Wl,-rpath /usr/include -Wl,-rpath /usr/lib -lmysqlclient
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/KeeperTime
